...
DROP TABLE IF EXISTS  `imw_twitter_graph`.`a_replied_b`;
CREATE TABLE          `imw_twitter_graph`.`a_replied_b` (
  `user_a_id`				INT(10)	     UNSIGNED			NOT NULL,
  `user_b_id`				INT(10)	     UNSIGNED			NOT NULL,
  `status_id`				INT(10)	     UNSIGNED			NOT NULL,
...
-- 
--
DROP TABLE IF EXISTS  `imw_twitter_graph`.`userinfo_to_scrape`;
CREATE TABLE  	      `imw_twitter_graph`.`userinfo_to_scrape` (

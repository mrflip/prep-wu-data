...
users_files=out/${sorted_id}-sorted-uff/twitter_user.tsv,out/${sorted_id}-sorted-uff/twitter_user_partial.tsv
...
hdp-sort $mid_file $output_file /bin/cat /bin/uniq 3

...
-- 
-- 
-- AAtsignsB_NN         = LOAD 'tmp/atsigns/a_atsigns_b_name' AS (
--   rsrc:        chararray,
--   user_a_name: chararray,
--   user_b_name: chararray,
--   tw_id:       long);
-- 
-- AAtsignsB_1S    = JOIN TwitterUserId BY screen_name, AAtsignsB_NN BY user_a_name PARALLEL $REDUCE_TASKS ;
-- 
-- rmf                      $ATSIGNS_OUT_DIR/a_atsigns_b_id_2  ;
-- STORE AAtsignsB_1S INTO '$ATSIGNS_OUT_DIR/a_atsigns_b_id_2' ;

...
edges_cut = FOREACH edges GENERATE user_a, user_b, a_fo_b, me_o;
edges_g   = GROUP edges_cut BY user_a;
adj_list  = FOREACH edges_g GENERATE group, 1.0f AS init_fo_rank, 1.0f AS init_me_rank, edges_cut.(user_b, a_fo_b, me_o);

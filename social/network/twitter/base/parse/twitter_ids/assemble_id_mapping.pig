...
twitter_user_id      = LOAD '$TW_OBJ_PATH/twitter_user_id'        AS (rsrc:chararray, uid:long, scrat:long, sn:chararray, prot:int, followers:long, friends:long, statuses:long, favourites:long, crat:long, sid:long, is_full:long, health:chararray);
twitter_user_sid     = LOAD '$TW_OBJ_PATH/twitter_user_search_id' AS (rsrc:chararray, sid:long, sn:chararray);

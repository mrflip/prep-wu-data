...
--   c   = AVG(tot_tok_stats_fg.tok_freq_ppb)*(1.0 - AVG(tot_tok_stats_fg.tok_freq_ppb))/var - 1.0;
--   GENERATE
--     AVG(tot_tok_stats_fg.tok_freq_ppb) AS u_prior,
--     c AS c_prior
--     ;
-- };
...
tot_tok_stats     = LOAD '$WORDBAG_ROOT/tot_tok_stats' AS (u_prior:double, c_prior:double);

...
-- TwitterUserId = LOAD 'fixd/tw/out/twitter_user_id' AS (
--   rsrc:             chararray,
--   id:               long,
--   scraped_at:       long,
...
--   ) ;
-- 
-- TwitterUserSearchId     = LOAD 'fixd/tw/out/twitter_user_search_id' AS (
--   rsrc:        chararray,
--   screen_name: chararray,
--   sid:         long,
--   id:          long ) ;
...
-- rmf                      fixd/tw/meta/twitter_user_id_matched ;
-- STORE MatchedIds_2 INTO 'fixd/tw/meta/twitter_user_id_matched';

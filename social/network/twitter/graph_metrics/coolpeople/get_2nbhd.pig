...
-- SearchTweet_n01_j        = JOIN SearchTweet                 BY twitter_user_screen_name, screen_name_n01 BY screen_name using 'replicated';
-- SearchTweet_n01_f        = FOREACH SearchTweet_n01_j        GENERATE rsrc, tw_id, created_at, user_id, favorited, truncated, repl_user_id, repl_tw_id, text, src, in_reply_to_screen_name, in_reply_to_sid, twitter_user_screen_name, twitter_user_sid, iso_language_code;
...
TwitterUser_n01          = ORDER   TwitterUser_n01_f        PARALLEL $PARALLEL_TINY
TwitterUserPartial_n01   = ORDER   TwitterUserPartial_n01_f PARALLEL $PARALLEL_TINY
TwitterUserProfile_n01   = ORDER   TwitterUserProfile_n01_f PARALLEL $PARALLEL_TINY
TwitterUserStyle_n01     = ORDER   TwitterUserStyle_n01_f   PARALLEL $PARALLEL_TINY
-- Tweet Objects
Tweet_n01                = ORDER   Tweet_n01_f              PARALLEL $PARALLEL_MED
SearchTweet_n01          = ORDER   Tweet_n01_f              PARALLEL $PARALLEL_MED
...
e_n01_FOi_f              = ORDER   e_n01_FOi_f              PARALLEL $PARALLEL_MED
e_n01_FOo_f              = ORDER   e_n01_FOo_f              PARALLEL $PARALLEL_MED
e_n01_REi_f              = ORDER   e_n01_REi_f              PARALLEL $PARALLEL_MED
e_n01_REo_f              = ORDER   e_n01_REo_f              PARALLEL $PARALLEL_MED
...
-- Sort and compact the relationship sets
a_follows_b_n01_f        = ORDER   a_follows_b_n01_f        PARALLEL $PARALLEL_MED
a_replies_b_n01_f        = ORDER   a_replies_b_n01_f        PARALLEL $PARALLEL_MED

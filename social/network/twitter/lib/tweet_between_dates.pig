...
--
-- Usage: PIG_OPTS='-Dmapred.reduce.tasks=X' pig -p TWEET=/path/to/tweets -p BEGIN=20101116000000L -p END=20101119000000L -p OUT=/path/to/output tweets_between_dates.pig
--

...
-- This script results in a tsv of users by followers count across the whole twitter stream.
-- ie:
--
--     followers  num_users
--
...
-- defaults
%default OUTPUT '/data/pkgd/social/network/twitter/users_by_followers_count'
...
FollowerGroup = GROUP UserWFollower BY followers_count;
FollowerCount = FOREACH FollowerGroup GENERATE group, COUNT(UserWFollower);

rmf $OUTPUT;
STORE FollowerCount INTO '$OUTPUT';

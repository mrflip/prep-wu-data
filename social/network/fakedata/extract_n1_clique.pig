...
%default OUT_n1x     '/tmp/seinfeld_n1x'
%default OUT_CLIQUE  '/tmp/seinfeld_clique_n1x_n1x'
...
clique_n1x_n1x_j      = JOIN e2o_edges_n1x_out BY node_b, n1x_nodes BY node using 'replicated';

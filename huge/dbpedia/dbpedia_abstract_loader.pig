...
%default DATA  's3n://infochimps-data/data/huge/dbpedia/abstracts/'
%default INDEX 'dbpedia'
%default OBJ   'abstracts'        

data = LOAD '$DATA' AS (title:chararray, abstract:chararray);
cut_data = FOREACH data GENERATE title, abstract;

...
wgetftprec.sh ftp://maia.usno.navy.mil/ser7/{ser7.dat,readme.bulla,readme.finals2000A,finals2000A.all,tai-utc.dat,deltat.data,deltat.preds}
...
#	  Available by ftp and web.
#	
#	deltat.data - This file contains Delta T (TT-UT1) values from the McCarthy

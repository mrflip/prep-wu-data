...
$spec{"×"}=47;
$spec{"÷"}=48;
$spec{"۔"}=49; # Urdu Sentence Boundary
$spec{"™"}=50;
$spec{"¤"}=51;
$spec{"£"}=52; 
$spec{"¥"}=53; # Yen
$spec{"￥"}=54; # Yuan
$spec{"‹"}=55; # quotation mark, half form
$spec{"›"}=56; # quotation mark, half form
$spec{"“"}=57; # quotation mark
$spec{"”"}=58; # quotation mark
$spec{"„"}=59; # quotation mark
$spec{"‚"}=60; # quotation mark, half form
$spec{"‘"}=61; # quotation mark, half form
$spec{"’"}=62; # quotation mark, half form
$spec{"「"}=63; # japanese/taiwanese quotation mark
$spec{"」"}=64; # japanese/taiwanese quotation mark
$spec{"『"}=65; # japanese/taiwanese quotation mark
$spec{"』"}=66; # japanese/taiwanese quotation mark
$spec{"〈"}=67; # chinese book title mark
$spec{"〉"}=68; # chinese book title mark
$spec{"《"}=69; # chinese book title mark
$spec{"》"}=70; # chinese book title mark
$spec{"₩"}=71; # Won
$spec{"¢"}=72; # Cent
$spec{"฿"}=73; # Baht
$spec{"₫"}=74; # Đồng

...
--
-- Usage: PIG_OPTS='-Dmapred.reduce.tasks' pig -p TWEET=/path/to/tweets -p BEGIN=20100801000000 -p END=20101119000000 -p OUT=/path/to/output tweets_between_dates.pig
--
...
info_out       = FOREACH tweet_by_date GENERATE created_at, COUNT(tweet) AS num_tweets;
